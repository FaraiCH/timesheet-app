...
> ⚠️ **NB:** You can do the same as the above inside the docker ubuntu container by using the command: `docker exec -it <container-name>`. Make sure you're not root! If you are, change to user `ubunutu` by typing `su ubuntu`
