 ...
 * @hidden
 */
export declare abstract class PdfBounds extends ChildProperty<PdfBounds> {
    /**
 ...
 * @hidden
 */
export declare abstract class PdfFont extends ChildProperty<PdfFont> {
    /**
 ...
 * @hidden
 */
export declare class PdfAnnotationBase extends ChildProperty<PdfAnnotationBase> {
    /**
 ...
 * @hidden
 */
export declare class ZOrderPageTable {
    private pageIdTemp;
    /** @private */
    /** @private */
    pageId: number;
