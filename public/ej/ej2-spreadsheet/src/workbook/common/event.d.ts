...
/** @hidden */
export declare const setValidation: string;
/** @hidden */
export declare const addHighlight: string;
/** @hidden */
export declare const dataValidate: string;
/** @hidden */
export declare const findNext: string;
/** @hidden */
export declare const findPrevious: string;
/** @hidden */
export declare const goto: string;
/** @hidden */
export declare const findWorkbookHandler: string;
/** @hidden */
export declare const replaceHandler: string;
/** @hidden */
export declare const replaceAllHandler: string;
/** @hidden */
export declare const showDialog: string;
/** @hidden */
export declare const findUndoRedo: string;
/** @hidden */
export declare const findKeyUp: string;
/** @hidden */
export declare const removeValidation: string;
/** @hidden */
...
/** @hidden */
export declare const pasteMerge: string;
/** @hidden */
export declare const setCFRule: string;
/** @hidden */
export declare const cFInitialCheck: string;
/** @hidden */
export declare const clearCFRule: string;
/** @hidden */
export declare const initiateClearCFRule: string;
/** @hidden */
export declare const cFRender: string;
/** @hidden */
export declare const cFDelete: string;
/** @hidden */
export declare const clear: string;
/** @hidden */
export declare const clearCF: string;
/** @hidden */
export declare const clearCells: string;
/** @hidden */
