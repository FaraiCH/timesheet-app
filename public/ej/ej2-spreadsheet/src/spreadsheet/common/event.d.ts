...
/** @hidden */
export declare const initiateConditionalFormat: string;
/** @hidden */
export declare const checkConditionalFormat: string;
/** @hidden */
export declare const setCF: string;
/** @hidden */
...
export declare const blankWorkbook: string;
/** @hidden */
