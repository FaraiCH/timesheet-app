...
import { PivotEngine, IPivotValues, IAxisSet, IDataSet } from '../../base/engine';
import { IPageSettings, IGroupSettings } from '../../base/engine';
import { IDrilledItem, ISort, IFilter, IFieldOptions, ICalculatedFields } from '../../base/engine';
...
export declare class PivotView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    isModified: boolean;
    /** @hidden */
    private isInitialRendering;
    /** @hidden */
    drillThroughElement: Element;
    /** @hidden */
    drillThroughValue: IAxisSet;
    /** @hidden */
    lastGridSettings: GridSettingsModel;
    /** @hidden */
    mouseEventArgs: MouseEventArgs;
    /** @hidden */
    filterTargetID: HTMLElement;
    ...
    */
     ...
     * @hidden
     */
    getAllSummaryType(): AggregateTypes[];
     ...
     * @hidden
     */
    getEngine(action: string, drillItem?: IDrilledItem, sortItem?: ISort, aggField?: IFieldOptions, cField?: ICalculatedFields, filterItem?: IFilter, memberName?: string, rawDataArgs?: any, editArgs?: any): void;
    ...
    /** @hidden */
    applyRowSelection(colIndex: number, rowIndex: number, e: MouseEvent | KeyboardEvent): void;
    /** @hidden */
